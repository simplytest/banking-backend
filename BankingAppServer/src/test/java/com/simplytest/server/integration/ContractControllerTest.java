...
public class ContractControllerTest {
    ...
    public void happyPathCreateCustomer() {
        ...
        String contractUrl = "/api/contracts";
        var dummyCustomer = createDummyCustomerDTO();
        ResponseEntity<String> response = restTemplate.postForEntity(contractUrl, dummyCustomer, String.class);
